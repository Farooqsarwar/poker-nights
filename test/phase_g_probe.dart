...
/// Phase G (premium) camera: upgrade and checkout inside the real
/// [ScreenShell] for a signed-in member, at phone, 320px and desktop width.
///
///   flutter test test/phase_g_probe.dart --update-goldens
///
...
void main() {
  ...
  Future<void> shoot(
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/phase_g/$name.png'),
    );
